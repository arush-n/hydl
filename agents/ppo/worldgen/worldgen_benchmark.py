...
from agents.ppo.worldgen.worldgen_il import (
    _ENVIRONMENT_HEAD_ALIASES,
    WorldgenILPPOAgent,
    WorldgenILPPOSettings,
)
from agents.ppo.worldgen.worldgen_trace import capture_recurrent_worldgen_trace
...
def make_worldgen_evaluator(
    ...
    *,
    ...
    movement_head = head_names.index("locomotion_gait_compass")
